...
(use-package netease-cloud-music
  :bind (:map evil-normal-state-map
	      ("<leader>mm" .  'netease-cloud-music-pause-or-continue)
	      ("<leader>mn" .  'netease-cloud-music-play-next-song)
	      ("<leader>mp" .  'netease-cloud-music-play-previous-song)
	      ("<leader>mf" .  'netease-cloud-music-search-song))
  :config
  (evil-define-key 'normal netease-cloud-music-mode-map
	   "<RET>"  'netease-cloud-music-play-song-at-point
	   "n"  'netease-cloud-music-play-next-song
	   "p"  'netease-cloud-music-play-previous-song
	   "f"  'netease-cloud-music-search-song)
  :hook (netease-cloud-music . evil-local-mode))
#+end_src
** 软件试验场
#+begin_src emacs-lisp
(use-package ggtags)
