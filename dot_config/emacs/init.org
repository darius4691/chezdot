...
(setq org-agenda-files '((concat (file-name-as-directory org-directory) "agenda.org")
			 (concat (file-name-as-directory org-directory) "notes.org"))
      org-archive-location (concat (file-name-as-directory org-directory) "archive.org::* From %s")
...
(use-package org-roam
  :ensure t
  :custom
  (org-roam-directory (file-truename (concat (file-name-as-directory org-directory) "roam")))
